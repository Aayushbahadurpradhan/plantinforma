...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _plantViewModel = Provider.of<PlantViewModel>(context, listen: false);
    });
    refresh();
    super.initState();
  }
  ...
  Future<void> refresh() async {
    ...
    _plantViewModel.getProducts();
    _authViewModel.getMyProducts();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer3<CategoryViewModel, AuthViewModel, PlantViewModel>(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: GridView.count(
                            ...
                            crossAxisCount: 2,
                            children: [
                              ...productVM.plants.map((e) => ProductCard(e))
                            ],
                          ),
                        ),
                      ],
        ...
        child: Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Image.asset("assets/icon/icon.gif", height: 80, width: 80,)),
                Expanded(
                    child: Align(
