...
class _SingleProductBodyState extends State<SingleProductBody> {
  ...
  Widget build(BuildContext context) {
    return Consumer2<SingleProductViewModel, AuthViewModel>(
      ...
      return singleProductVM.plant == null
          ? Scaffold(
              body: Container(
                child: Text("Error"),
              ),
            )
          : singleProductVM.plant!.id == null
              ? Scaffold(
                  body: Center(
                    child: Container(
              ...
              : Scaffold(
                      ...
                      Builder(builder: (context) {
                        ...
                        try {
                          isFavorite = authVm.favorites.firstWhere(
                              (element) =>
                                  element.plantId ==
                                  singleProductVM.plant!.id);
                        } catch (e) {}

                        return IconButton(
                            onPressed: () {
                              print(singleProductVM.plant!.id!);
                              favoritePressed(
                                  isFavorite, singleProductVM.plant!.id!);
                            },
                            icon: Icon(
                              Icons.favorite,
                  ...
                  body: SingleChildScrollView(
                    child: Column(
                      children: [
                        Image.network(
                          singleProductVM.plant!.imageUrl.toString(),
                          height: 400,
                        ...
                        Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "temp:" +
                                      singleProductVM.plant!.temperatura
                                          .toString(),
                                  style: TextStyle(
                                      fontSize: 30,
                                      color: Colors.green,
                                ...
                                Text(
                                  singleProductVM.plant!.plantName
                                      .toString(),
                                  style: TextStyle(
                                      fontSize: 24,
                                ...
                                Text(
                                  singleProductVM.plant!.plantDescription
                                      .toString(),
                                  style: TextStyle(
                                    fontSize: 22,
                                  ),
