      ...
      return Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                if (_authViewModel.myProduct != null && _authViewModel.myProduct!.isEmpty) Center(child: Text("You can add your plants here")),
      ...
      child: Container(
        ...
        child: Card(
          ...
          child: ListTile(
            ...
            title: Text(e.plantName.toString()),
            subtitle: Text(e.temperatura.toString()),
            trailing: Wrap(
              children: [
                IconButton(
                  onPressed: () {
